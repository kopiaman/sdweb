  ...
  <section class="py-28 bg-primary-50" id="clients" data-aos="fade-up">
    <div class="container">
      ...
      <div class="mb-8 md:mb-16 text-center">
        <h2 class="display-4 mb-4">Did you know?</h2>
      </div>
      ...
      <div class="row">
        <div class="col lg:w-3/12 md:w-6/12" data-aos="fade-left">
          ...
          <p>
            AI can automate up to <strong>70%</strong> of routine tasks in
        ...
        <div class="col lg:w-3/12 md:w-6/12" data-aos="fade-left">
          ...
          <p>
            Implementing AI can lead to cost savings and efficiency gains of
        ...
        <div class="col lg:w-3/12 md:w-6/12" data-aos="fade-right">
          ...
          <p>
            A survey found that <strong>69%</strong> of customers prefer
        ...
        <div class="col lg:w-3/12 md:w-6/12" data-aos="fade-right">
          ...
          <p>
            AI has the potential to boost global productivity by up to
            <strong>14%</strong> by 2030.
          </p>
        </div>
      </div>
    </div>
